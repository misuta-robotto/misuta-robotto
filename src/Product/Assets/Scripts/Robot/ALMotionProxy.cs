...
namespace AL {
    public class ALMotionProxy {
        public static int FRAME_TORSO = 0;
        public static int FRAME_WORLD = 1;
        public static int FRAME_ROBOT = 2;

        public static int AXIS_MASK_POSITION = 7;
        public static int AXIS_MASK_ROTATION = 56;
        ...
        [DllImport("bridge_d")]
        private static extern void AlMotionProxySetPositions(IntPtr self, IntPtr effectorNames, int frame, IntPtr position, float fractionMaxSpeed, int axisMask);
        ...
        public void SetPositions(string[] effectorNames, int frame, float[] position, float fractionMaxSpeed, int axisMask)
        {
            AlMotionProxySetPositions(
                unmanagedMem,
                new ALValue(effectorNames).Pointer,
                frame,
                new ALValue(position).Pointer,
                fractionMaxSpeed,
                axisMask
            );
        }
